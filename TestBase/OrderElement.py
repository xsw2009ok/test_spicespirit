...
#
ORDER_MAINPAGE_CUSTOMER = "//div/ul/li/a[i[@class='i11']]"
...
ORDER_INFO_SELECT_GOODS = "//div[@id='order_match_lists']/ul/li[1]/span[1]"
...
ORDER_INFO_START_TIME_DEFAULT = "//div[@id='ui-datepicker-div']/div[3]/button[contains(text(),'当前')]"
ORDER_INFO_START_TIME_DONE = "//div[@id='ui-datepicker-div']/div[3]/button[contains(text(),'确认')]"
ORDER_INFO_PAY_INTERNET = "//div/input[@name='pay_way' and @value = '2']"
ORDER_INFO_PAY_CASH = "//div/input[@name='pay_way' and @value = '1']"
...
ORDER_INFO_INVOICE_SAVE = "//div/div/div/a[@class='keep-btn keep-gray invoice_save']"
ORDER_INFO_INVOICE_MORE = "//div/div[@class='invoice-btn']/a"
